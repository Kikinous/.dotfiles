...
" Plugin: ariline - configuration tmux{{{3
"
...
" Configuration selon my-oh-zsh {{{1
" comments {{{2
"===============================================================================
...
" Ajustement de Julien {{{1
" Python : add the proper PEP8 indentation {{{2
"
...
"------------------------------------------------------------
"
" learnvimscriptthehardway.stevelosh.com  {{{2
"
